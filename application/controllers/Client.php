...
class Client extends CI_Controller
{
        ...
        public function Inscription()
        {
            ...
            $this->form_validation->set_rules('prenom_client','prenom', 'required',
                array('required'=>'Erreur dans le champ %s'));
            $this->form_validation->set_rules('pseudo_client','pseudo', 'required',
                array('required'=>'Erreur dans le champ %s'));
            $this->form_validation->set_rules('mot_de_passe','motdepasse', 'required',
                array('required'=>'Erreur dans le champ %s'));
            $this->form_validation->set_rules('e_mail_client','email', 'required',
                array('required'=>'Erreur dans le champ %s'));
           ...
           // Condition mise en place pour vérifier si les données du formulaire sont conforme, si c'est le ca, on ajoute le client dans la base de données
            ...
            {
                $this->load->model('Client_model');
                $aCreation = $this->Client_model->CreationClient();
                $aCreation['CreationClient']= $aCreation;
        ...
        public function Deconnexion()
        {
            ...
            redirect(site_url("Vaisseau/Accueil"));
        }
