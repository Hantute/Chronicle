		...
		<?php  echo validation_errors();?>
    		<fieldset>
    			...
    			<p class="text-danger"><b> * Ces zones sont obligatoires pour valider votre formulaire d'inscription en tant que soldat dans notre armée</b></p>
    				...
    				<div class="col-sm-10">
                                    <input type="text" disabled="TRUE" class="form-control border-success" name="nom_client" id="nom_client" value="<?= $this->session->user->nom_client; ?>"  >
                                    <span id="pasnom"></span>
    				</div>
                            </div>
                            <div class="form-group row">
    				...
    				<div class="col-sm-10">
                            ...
                            <div class="form-group_row" name="date" id="date">
                                ...
                                <?php if(isset($this->session->user->date_modification)){ ?>
