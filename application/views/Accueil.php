				...
				<div class="col-sm-12 col-lg-8" id="Univers">
					<section>
					<h2 style="font-size:175%"><b>Accueil</b></h2>
						<article>
							<h3 style="font-size:125%"><b>L'Univers</b></h3>
								<h4 id="Lieu">Lieu</h4>
