...
<head>
  <meta charset='utf-8' />
  <meta name="Modification d'un vaisseau de combat" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <title> Formulaire de modification du vaisseau</title>
...
<body>
  <header>
    <p style=font-size:200%> Modifier un vaisseau de combat</p>
  </header>
  <nav id="navbar" class="navbar navbar-expand-sm bg-info navbar-info">
    ...
    <div class="container-fluid">
          <?php if($this->session->user):?>
            <p> <?php echo "Bonjour commandant <br> ".$this->session->user->prenom_client." ".$this->session->user->nom_client; ?> !<br>
          <?php endif;?><br>
              <?php echo $citation; ?>
